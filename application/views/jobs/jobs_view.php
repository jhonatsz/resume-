...
<!-- END OF NAV -->
    <div class='col-md-9'>
      <form method='post' action='<?=base_url();?>index.php/jobs/search'>
      <div class="col-md-10 col-md-offset-2" style='margin-bottom:20px;margin-left:0px;'>
            <div class="input-group">

                  <input type="text" class="form-control" placeholder="Search for..." id="searchTerm" name="category" value='' required>
