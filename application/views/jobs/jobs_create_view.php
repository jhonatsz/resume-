	...
	<div class="row">
      <div class="col-md-9 col-md-offset-3">
        <div class="well well-sm">
          <form class="form-horizontal" action="<?=base_url();?>index.php/jobs/create/new" method="post">
          <fieldset>
            <legend class="text-center">Jobs Information | Create</legend>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <textarea class="form-control" id="message" name="description" placeholder="Please enter your message here..." rows="5"></textarea>
              </div>
            </div>
